...
#define GRAD_PASSPORT_PADDING_X                 (0.0200 * X_SCALE)
#define GRAD_PASSPORT_PADDING_Y                 (0.0160 * Y_SCALE)
...
#define GRAD_PASSPORT_DEFAULT_RIGHTCOLUMN_X     (GRAD_PASSPORT_DEFAULT_X + GRAD_PASSPORT_DEFAULT_W / 2)
